/*
  Project name:
     ...
     Flavour I - IV
     Hex File: _06_kidSerie_sketch_allInOne_Adafruit_IO_FakeToReal_Feeds.ino
   Revision History:
     20161029:
  ...
  https://learn.adafruit.com/mqtt-adafruit-io-and-you/intro-to-adafruit-mqtt
   Description:
     ...
     https://github.com/giljr/kidSeries/blob/master/_06_kidSerie_sketch_allInOne_Adafruit_IO_FakeToReal_Feeds.ino
